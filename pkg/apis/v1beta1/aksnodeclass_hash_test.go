...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("InstallGPUDrivers", "5994291664450980485", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{InstallGPUDrivers: lo.ToPtr(false)}}),
	)
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1beta1.AKSNodeClass) {
		...
		Entry("InstallGPUDrivers", v1beta1.AKSNodeClass{Spec: v1beta1.AKSNodeClassSpec{InstallGPUDrivers: lo.ToPtr(false)}}),
	)
