...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("InstallGPUDrivers", "5994291664450980485", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{InstallGPUDrivers: lo.ToPtr(false)}}),
	)
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1alpha2.AKSNodeClass) {
		...
		Entry("InstallGPUDrivers", v1alpha2.AKSNodeClass{Spec: v1alpha2.AKSNodeClassSpec{InstallGPUDrivers: lo.ToPtr(false)}}),
	)
